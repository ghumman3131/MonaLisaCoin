    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceMNL = 40;
    ...
    QString titleText       = tr("MonaLisaCoin Core");
    ...
    QString copyrightTextMNL  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dogecoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceMNL,copyrightTextMNL);
