    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MonaLisaCoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // MonaLisaCoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // MonaLisaCoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // MonaLisaCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MonaLisaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and monalisacoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About MonaLisaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MonaLisaCoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for MonaLisaCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MonaLisaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MonaLisaCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MonaLisaCoin Core help message to get a list with possible MonaLisaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MonaLisaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MonaLisaCoin network", "", count));
}
...
{
    QString strTitle = tr("MonaLisaCoin"); // default title
