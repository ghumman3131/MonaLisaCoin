    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MonaLisaCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About MonaLisaCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  monalisacoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MonaLisaCoin Core is shutting down...") + "<br /><br />" +
