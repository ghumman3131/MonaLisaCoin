...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MMNL");
    case kBTC: return QString("kMNL");
    case BTC: return QString("MNL");
    case mBTC: return QString("mMNL");
    case uBTC: return QChar(0x03BC) + QString("MNL");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-MonaLisaCoins (1,000,000)");
    case kBTC: return tr("Kilo-MonaLisaCoins (1,000)");
    case BTC: return tr("MonaLisaCoins");
    case mBTC: return tr("Milli-MonaLisaCoins (1 / 1,000)");
    case uBTC: return tr("Micro-MonaLisaCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
