...
public:
    CMainParams() {
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "Second week of new year 2018";
        ...
        vSeeds.push_back(CDNSSeedData("monalisacoin.com", "seed.monalisacoin.com"));
        vSeeds.push_back(CDNSSeedData("multiMNL.org", "seed.multiMNL.org"));
        vSeeds.push_back(CDNSSeedData("multiMNL.org", "seed2.multiMNL.org"));
        vSeeds.push_back(CDNSSeedData("MNLr.monalisacoin.com", "seed.MNLr.monalisacoin.com"));
        ...
        //TODO: fix this for monalisacoin -- plddr
