...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MonaLisaCoin Core monalisacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  monalisacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monalisacoin transaction") + "\n" +
              "  monalisacoin-tx [options] -create [commands]   " + _("Create hex-encoded monalisacoin transaction") + "\n" +
              "\n";
