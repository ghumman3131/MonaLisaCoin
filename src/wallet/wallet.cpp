        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // MonaLisaCoin: Disable free transactions
...
{
    // MonaLisaCoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // MonaLisaCoin: Add an increased fee for each dust output
        nFeeNeeded += GetMonaLisaCoinDustFee(tx.vout, minTxFee);
    }
